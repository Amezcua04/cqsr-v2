...
export const dataServicios = [
  ...
  },
  {
    ...
    subtitulo:
      "Cuidado especializado para los pacientes en condiciones críticas.",
    url: null,
    image: Intermedia,
    etiqueta: "Conoce más",
  },
  ...
  {
    titulo: "Farmacia",
    subtitulo: "Amplia variedad de medicamentos, con servicio las 24 horas.",
    url: null,
    image: Farmacia,
...
export const dataEspecialistas = [
  ...
  },
  {
    imagen: example,
    especialidad: "Pediatría",
    subespecialidad: "Cirugía Pediatrica",
